...
def get_args():
    ...
    # model option
    parser.add_argument("--engine", type=str, default="../checkpoint/deeplabv3plus_resnet50_cityscapes/model_best_jetson_fp16.engine",help="model engine path")
    parser.add_argument("--onnx", type=str, default="../checkpoint/deeplabv3plus_resnet50_cityscapes/model_best_jetson.onnx", help="model onnx path")
